...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0 px-lg-3">
            <a href="index" class="navbar-brand ml-lg-3">
                <h1 class="m-0 text-primary">AcadeMix (LMS)</h1>
            </a>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <p>AcadeMix is an educational website based in India. We are committed to 
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                    ...
                    <p class="mb-4 pb-2">You should start learning with AcadeMix because we offer a diverse range of high-quality educational resources and experienced instructors to support your learning journey.</p>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>The skilled instructors at AcadeMix are dedicated to providing high-quality education and mentorship to students.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>AcadeMix offers powerful and highly professional international certificates that are enriched with valuable skills.</p>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="mt-n1">
                            ...
                            <p class="m-0">AcadeMix provides online classes to accommodate flexible and accessible learning for students.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>M.Shivakamal</h2>
                            <p>M.Shivakamal also takes on the role of a full-stack developer to help expedite the project's completion. 
                        ...
                        <div class="social">
                          <a href="https://wa.me/+919959873005" target="_blank"><i class="fab fa-whatsapp"></i></a>
                          <a href="https://www.linkedin.com/in/manthena-shivakamal-8b31a1228/" target="_blank"><i class="fab fa-linkedin"></i></a>
                          <a href="https://www.instagram.com/m_sk.028/" target="_blank"><i class="fab fa-instagram"></i></a>  
                          <a href="https://github.com/shivakamal2004" target="_blank"><i class="fab fa-github"></i></a>      
                        </div>
                    </div>
                </div>  
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>MD.Sameer</h2>
                            <p>MD.Sameer is the front-end developer and user interface (UI) designer. 
                        ...
                        <div class="social">
                          <a href="https://wa.me/+918897752172" target="_blank"><i class="fab fa-whatsapp"></i></a>
                          <a href="https://www.linkedin.com/in/mohammed-sameer-b39a8b33b/" target="_blank"><i class="fab fa-linkedin"></i></a>
                          <a href="https://www.instagram.com/sameer_24638/?next=%2F" target="_blank"><i class="fab fa-instagram"></i></a>  
                          <a href="https://github.com/Mohdsameer045" target="_blank"><i class="fab fa-github"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>D.Ahamad</h2>
                            <p>D.Ahamad is the back-end developer and database specialist. 
                        ...
                        <div class="social">
                          <a href="https://wa.me/+917671070737" target="_blank"><i class="fab fa-whatsapp"></i></a>
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Call Us</h4>
                                <p class="m-0">+91 9959873005 or 8897752172</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <a href="https://mail.google.com//mail/?view=cm&fs=1&tf=1&to=academix2099@gmail.com" target="_blank"><p class="m-0">academix2099@gmail.com</p></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-content">
        ...
        <ul class="wrapper">
            ...
            <span><a href="https://wa.me/+919959873005" target="_blank"><i class="fab fa-whatsapp"></i></a></span>    
            </li>
            <li class="icon instagram">
                <span class="tooltip">Instagram</span>
            <span><a href="https://www.instagram.com/m_sk.028/" target="_blank"><i class="fab fa-instagram"></i></a></span>    
            </li>
            <li class="icon github">
                <span class="tooltip">Github</span>
            <span><a href="https://github.com/shivakamal2004" target="_blank"><i class="fab fa-github"></i></a></span>    
            </li>
            <li class="icon youtube">
                <span class="tooltip">Youtube</span>
            <span><a href="https://www.youtube.com/results?search_query=web+sadhna+samyoga" target="_blank"><i class="fab fa-youtube"></i></a></span>    
            </li>
            
        </ul>
    </div>
        <div class="footer-bottom">
            <p>Copyright &copy; <a href="#">AcadeMix</a></p>
        </div>
    <!-- Footer End -->
